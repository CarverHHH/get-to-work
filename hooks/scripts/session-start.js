...
const counterPath = path.join(DATA_DIR, ".tool-call-counter.json");
...
try {
  ...
  process.stdin.on("end", () => {
    ...
    if (!current_state || current_state === "IDLE" || current_state === "DONE")
      return;

    const taskInfo =
      plan && plan.total_tasks > 0
