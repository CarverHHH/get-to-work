 ...
 * Appends tool call records to .get-to-work/memory/observations.jsonl
 */
...
const OBSERVATIONS_FILE = path.join(DATA_DIR, "memory", "observations.jsonl");
const MAX_LINES = 500;
  ...
  process.stdin.on("end", () => {
    try {
      ...
      const record = {
        ...
        command: toolUse.tool_input?.command
          ? toolUse.tool_input.command.substring(0, 120)
          : null,
      };
